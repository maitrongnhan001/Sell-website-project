...
--
-- Host: localhost
-- Generation Time: Nov 25, 2021 at 04:11 PM
...
(15, 3, NULL, 3, '2021-11-25', NULL, 'Đặt hàng'),
(16, 3, NULL, 3, '2021-11-25', NULL, 'Đặt hàng');
...
(22, 'Assus', 'ASUSTeK Computer Incorporated (Asus), tên một tập đoàn đa quốc gia thành lập vào 1989 có trụ sở tại Đài Loan. ... Riêng về mặt hàng máy tính xách tay trong năm 2016, laptop ASUS là thương hiệu có doanh số sản phẩm bán ra cao nhất với tỷ trọng trung bình chiếm tới 34,75%', 20000000, 100, 17),
...
(28, 'Áo thun cổ ngắn', 'KIỂU DÁNG: Slim Fit\r\n\r\nCHI TIẾT:\r\n\r\n- Áo Thun Nam Polo Ngắn Tay 5S (APC21013) Chất Liêu 100% Coolmax Phối Viền Năng Động, Trẻ Trung, Nam Tính có thiết kế kiểu dáng cơ bản với dáng ôm vừa, cổ bẻ, tay ngắn in logo 5S, kiểu dáng thể thao.\r\n\r\n- Áo Thun Nam Polo Ngắn Tay 5S (APC21013) Chất Liêu 100% Coolmax Phối Viền Năng Động, Trẻ Trung, Nam Tính, dễ dàng phối cùng quần jeans hoặc shorts, giày thể thao hoặc giày lười, thích hợp sử dụng trong các dịp đi chơi, gặp gỡ bạn bè và các hoạt động ngoài trời.', 169000, 1000, 13),
...
--
ALTER TABLE `DatHang`
  MODIFY `SoDonDH` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `HinhHangHoa`
  MODIFY `MaHinh` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
